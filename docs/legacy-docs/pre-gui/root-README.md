...
- [Technical Docs Overview](../../README.md) - architecture, configuration, and setup
- [Coding Techniques Index](../../coding-techniques/README.md) - one note per reusable coding technique
- [Code Blocks Index](../../code-blocks/README.md) - one note per concrete function or script block
